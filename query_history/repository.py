    ...
    def list_recent(
        ...
        *,
        ...
        if organization_id is not None:
            stmt = stmt.outerjoin(Dataset, QueryHistory.dataset_id == Dataset.dataset_id).where(
                (QueryHistory.organization_id == organization_id) | (Dataset.organization_id == organization_id)
            )
