...
def test_bnb_cycle_writes_isolated_artifacts_and_verdict(tmp_path, monkeypatch):
    ...
    probes = {
        "torch_preinstall": {"ok": True, "json": {"torch_version": "2.5.1+cu118", "torch_cuda_version": "11.8"}, "stdout": "{}"},
        "torch_runtime": {"ok": True, "json": {"torch_version": "2.5.1+cu118", "torch_cuda_version": "11.8"}, "stdout": "{}"},
        "torch_cuda": {"ok": True, "json": {"cuda_available": True, "device_name": "Tesla P100-PCIE-16GB", "capability": [6, 0], "arch_list": ["sm_60"], "basic_cuda_tensor_test": True, "synchronize": True}, "stdout": "{}"},
